...
mat_truck_wheels = make_mat("TruckWheels", (0.05, 0.05, 0.05, 1))
...
add_mesh("Road", bpy.ops.mesh.primitive_cube_add, mat_road,
         (0, 0, 0.01), (2.5, 12, 0.02))

# Truck — boxy shape on the road
add_mesh("TruckBody", bpy.ops.mesh.primitive_cube_add, mat_truck,
         (1.5, 0, 0.8), (1.2, 2.5, 0.8))
add_mesh("TruckCab", bpy.ops.mesh.primitive_cube_add, mat_truck,
         (1.5, -3.0, 0.9), (1.0, 1.0, 0.9))
add_mesh("TruckWheel1", bpy.ops.mesh.primitive_cylinder_add, mat_truck_wheels,
         (0.3, -1.5, 0.3), (0.3, 0.3, 0.15),
         rot=(math.radians(90), 0, 0))
add_mesh("TruckWheel2", bpy.ops.mesh.primitive_cylinder_add, mat_truck_wheels,
         (2.7, -1.5, 0.3), (0.3, 0.3, 0.15),
         rot=(math.radians(90), 0, 0))
add_mesh("TruckWheel3", bpy.ops.mesh.primitive_cylinder_add, mat_truck_wheels,
         (0.3, 1.5, 0.3), (0.3, 0.3, 0.15),
         rot=(math.radians(90), 0, 0))
add_mesh("TruckWheel4", bpy.ops.mesh.primitive_cylinder_add, mat_truck_wheels,
         (2.7, 1.5, 0.3), (0.3, 0.3, 0.15),
         rot=(math.radians(90), 0, 0))

# Four captives kneeling beside the truck (arms raised, on the left side)
# Kneeling approximated with "seated" pose at ground level
build_regular_male("Nomad1", mat_nomad1, (-1.5, -1.5, 0), pose="arms_raised")
build_regular_male("Nomad2", mat_nomad2, (-1.5, -0.5, 0), pose="arms_raised")
build_regular_male("Nomad3", mat_nomad3, (-1.5, 0.5, 0), pose="arms_raised")
build_regular_female("Gale", mat_gale, (-1.5, 1.5, 0), pose="arms_raised")

# Armed raiders standing behind the captives
build_regular_male("Hockey", mat_hockey, (-3.0, -1.0, 0), pose="standing")
build_regular_male("Goggles", mat_goggles, (-3.0, 1.0, 0), pose="standing")
build_large_figure("Heavy", mat_heavy, (-3.5, 0, 0), pose="standing")

# Sniper scope vignette — ring around the edge of frame (composited in front of camera)
# Create a torus close to camera to simulate scope ring
bpy.ops.mesh.primitive_torus_add(
    major_radius=1.8, minor_radius=0.35,
    location=(0, 0, 12.5))
scope_ring = bpy.context.active_object
scope_ring.name = "ScopeRing"
scope_ring.scale = (1.0, 1.0, 0.3)
scope_ring.rotation_euler = (0, 0, 0)
scope_ring.data.materials.append(mat_scope)

# Crosshair lines (thin cylinders near camera)
add_mesh("CrosshairH", bpy.ops.mesh.primitive_cylinder_add, mat_crosshair,
         (0, 0, 12.5), (0.008, 0.008, 1.6),
         rot=(0, math.radians(90), 0))
add_mesh("CrosshairV", bpy.ops.mesh.primitive_cylinder_add, mat_crosshair,
         (0, 0, 12.5), (0.008, 0.008, 1.6),
         rot=(math.radians(90), 0, 0))

# Camera — high above looking straight down (sniper scope POV)
setup_camera(scene, loc=(0, 0, 14), target_loc=(0, 0, 0), lens=35)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_002.png"
