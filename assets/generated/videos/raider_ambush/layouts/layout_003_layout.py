...
# ── Extreme Close-Up: Gorilla face with sniper scope ────────────────────────
# Place the gorilla's head large and centered, with only head visible.
# We build just the head and scope, no full body — extreme close-up framing.

# Large gorilla head — center of frame
add_mesh("Gorilla_Head", bpy.ops.mesh.primitive_uv_sphere_add, mat_gorilla,
         (0, 0, 1.5), (0.9, 0.8, 0.8))

# Brow ridge — heavy overhang above the eyes
add_mesh("Gorilla_Brow", bpy.ops.mesh.primitive_cube_add, mat_gorilla,
         (0, -0.55, 1.75), (0.7, 0.15, 0.12))

# Right eye — pressed to scope, so partially hidden
add_mesh("Gorilla_EyeR", bpy.ops.mesh.primitive_uv_sphere_add, mat_eye,
         (0.25, -0.65, 1.55), (0.1, 0.08, 0.08))

# Left eye — squinting, visible
add_mesh("Gorilla_EyeL", bpy.ops.mesh.primitive_uv_sphere_add, mat_eye,
         (-0.25, -0.65, 1.55), (0.1, 0.08, 0.08))

# Nose / muzzle — protruding forward
add_mesh("Gorilla_Muzzle", bpy.ops.mesh.primitive_uv_sphere_add, mat_gorilla,
         (0, -0.75, 1.3), (0.3, 0.2, 0.25))

# Jaw
add_mesh("Gorilla_Jaw", bpy.ops.mesh.primitive_cube_add, mat_gorilla,
         (0, -0.55, 1.1), (0.5, 0.25, 0.15))

# Sniper scope — long cylinder extending from the right eye outward
add_mesh("Scope_Tube", bpy.ops.mesh.primitive_cylinder_add, mat_scope,
         (0.25, -1.4, 1.55), (0.08, 0.08, 0.5),
         rot=(math.radians(90), 0, 0))

# Scope eyepiece — wider ring pressed against the eye
add_mesh("Scope_Eyepiece", bpy.ops.mesh.primitive_cylinder_add, mat_scope,
         (0.25, -0.85, 1.55), (0.12, 0.12, 0.06),
         rot=(math.radians(90), 0, 0))

# Scope objective lens — wider end
add_mesh("Scope_Objective", bpy.ops.mesh.primitive_cylinder_add, mat_scope,
         (0.25, -1.9, 1.55), (0.11, 0.11, 0.04),
         rot=(math.radians(90), 0, 0))

# Hint of horned helmet — two horn stubs at top of head
mat_helmet = make_mat("Helmet", (0.15, 0.12, 0.08, 1))
add_mesh("Horn_L", bpy.ops.mesh.primitive_cone_add, mat_helmet,
         (-0.45, -0.2, 2.3), (0.1, 0.1, 0.3),
         rot=(0, math.radians(20), 0))
add_mesh("Horn_R", bpy.ops.mesh.primitive_cone_add, mat_helmet,
         (0.45, -0.2, 2.3), (0.1, 0.1, 0.3),
         rot=(0, math.radians(-20), 0))

# Helmet rim across forehead
add_mesh("Helmet_Rim", bpy.ops.mesh.primitive_cube_add, mat_helmet,
         (0, -0.5, 1.9), (0.75, 0.15, 0.08))

# ── Camera: directly in front at face level, very close ─────────────────────
setup_camera(scene, loc=(0, -3.5, 1.5), target_loc=(0, 0, 1.5), lens=50)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_003.png"
