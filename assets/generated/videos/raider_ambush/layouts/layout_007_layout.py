...
# Desert road - a long flat strip to suggest a road surface
mat_road = make_mat("Road", (0.3, 0.25, 0.18, 1))
add_mesh("Road", bpy.ops.mesh.primitive_cube_add, mat_road,
         (0, 0, 0.01), (2.0, 12.0, 0.02))

# Single figure stumbling, grabbing at his leg - use fighting_stance to suggest bent/reaching posture
# Place Cranial center frame, slightly leaning forward
build_regular_male("Cranial", mat_cranial, (0, 0, 0), pose="fighting_stance")

# Camera at eye level for medium shot - close enough for medium framing
# Eye level ~1.5m, positioned in front and slightly to the side
setup_camera(scene, loc=(2.5, -3.5, 1.5), target_loc=(0, 0, 1.0), lens=50)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_007.png"
