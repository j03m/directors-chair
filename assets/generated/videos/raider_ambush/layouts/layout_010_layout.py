...
mat_cover = make_mat("Cover", (0.3, 0.25, 0.2, 1))

# Ground
add_ground(mat_ground)

# Desert road — a long flat strip
add_mesh("Road", bpy.ops.mesh.primitive_cube_add, mat_ground,
         (0, 0, 0.01), (8, 1.5, 0.02))

# Cover object (truck/motorcycle silhouette) on the right side
add_mesh("Truck_Body", bpy.ops.mesh.primitive_cube_add, mat_cover,
         (3.5, 0.5, 0.6), (1.2, 0.6, 0.6))
add_mesh("Truck_Cab", bpy.ops.mesh.primitive_cube_add, mat_cover,
         (4.2, 0.5, 1.2), (0.5, 0.5, 0.4))
add_mesh("Truck_WheelL", bpy.ops.mesh.primitive_cylinder_add, mat_cover,
         (3.0, -0.1, 0.2), (0.25, 0.25, 0.1),
         rot=(math.radians(90), 0, 0))
add_mesh("Truck_WheelR", bpy.ops.mesh.primitive_cylinder_add, mat_cover,
         (4.0, -0.1, 0.2), (0.25, 0.25, 0.1),
         rot=(math.radians(90), 0, 0))

# Gale — left side of frame, fighting stance (aiming gun)
build_regular_female("Gale", mat_gale, (-3.0, 0.0, 0.0), pose="fighting_stance")

# Gun prop for Gale — a long cylinder extending from her arms
add_mesh("Gale_Gun", bpy.ops.mesh.primitive_cylinder_add, mat_cover,
         (-2.55, -0.6, 1.1), (0.05, 0.05, 0.5),
         rot=(math.radians(-60), 0, math.radians(5)))

# Heavy raider — right side, emerging from behind the truck, fighting stance
build_large_figure("Heavy", mat_heavy, (2.0, -0.3, 0.0), pose="fighting_stance")

# Camera — eye level, facing the action from a front-facing angle
setup_camera(scene, loc=(0.0, -7.0, 1.5), target_loc=(0.0, 0.0, 1.2), lens=32)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_010.png"
