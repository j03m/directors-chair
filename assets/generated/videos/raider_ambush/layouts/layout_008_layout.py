...
mat_rock = make_mat("Rock", (0.35, 0.3, 0.25, 1))

# Ground plane
add_ground(mat_ground)

# Cliff edge — raised rocky platform
add_mesh("CliffTop", bpy.ops.mesh.primitive_cube_add, mat_rock,
         (0, 0, 0.15), (4, 3, 0.15))
add_mesh("CliffEdge", bpy.ops.mesh.primitive_cube_add, mat_rock,
         (0, -2.5, -0.3), (4, 0.8, 0.6))

# Cranial (regular male) — prone on the left, facing right toward gorilla
# "fallen" pose approximates prone/lying flat
build_regular_male("Cranial", mat_cranial, (-1.2, -0.5, 0.3), pose="fallen")

# Gorilla (large figure) — prone on the right, facing left toward cranial
# Mirror the fallen pose by placing head toward cranial
build_large_figure("Gorilla", mat_gorilla, (1.2, -0.5, 0.3), pose="fallen")
...
add_mesh("Rifle_Cranial", bpy.ops.mesh.primitive_cylinder_add, mat_rifle,
         (-1.2, -1.8, 0.4), (0.03, 0.03, 0.7),
         rot=(math.radians(85), 0, math.radians(5)))
add_mesh("Rifle_Gorilla", bpy.ops.mesh.primitive_cylinder_add, mat_rifle,
         (1.2, -1.8, 0.4), (0.04, 0.04, 0.8),
         rot=(math.radians(85), 0, math.radians(-5)))

# Distant desert terrain below the cliff
mat_desert = make_mat("Desert", (0.6, 0.5, 0.3, 1))
...
setup_camera(scene, loc=(3.5, 1.5, 0.6), target_loc=(0, -0.5, 0.4), lens=28)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_008.png"
