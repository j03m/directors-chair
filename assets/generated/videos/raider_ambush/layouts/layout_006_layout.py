...
# Desert road suggestion — a lighter strip across the ground
road_mat = make_mat("Road", (0.3, 0.25, 0.18, 1))
add_mesh("Road", bpy.ops.mesh.primitive_cube_add, road_mat,
         (0, 0, 0.01), (2.0, 15, 0.01))

# Single figure stumbling, grabbing at his own neck — fighting_stance conveys tension/reaching
# Place figure at center, slightly off-axis for natural framing
build_regular_male("Greasy", greasy_mat, (0, 0, 0), pose="fighting_stance")

# Camera at eye level, slightly to the side — medium shot
# Eye level ~1.5m, offset to the right for side angle
setup_camera(scene, loc=(3.0, -2.5, 1.5), target_loc=(0, 0, 1.2), lens=50)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_006.png"
