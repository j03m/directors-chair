...
# Add a cliff edge suggestion — a raised rock slab
mat_cliff = make_mat("Cliff", (0.3, 0.25, 0.18, 1))
add_mesh("CliffEdge", bpy.ops.mesh.primitive_cube_add, mat_cliff,
         (0, 0, -0.3), (4, 3, 0.3))

# Characters — prone gorilla and cranial side by side at cliff edge, robot standing behind
# Gorilla (large) lying prone, head toward cliff edge (positive X)
build_large_figure("Gorilla", mat_gorilla, (-0.8, -0.3, 0.0), pose="fallen")

# Cranial (regular male) lying prone beside gorilla, turned toward gorilla
build_regular_male("Cranial", mat_cranial, (0.8, -0.3, 0.0), pose="fallen")

# Robot (regular male) standing just behind the two prone figures
...
setup_camera(scene, loc=(0, -4.5, 3.5), target_loc=(0, 0.2, 0.5), lens=32)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_011.png"
