...
# Standing figure on the left — heavy raider looming over the kneeling nomads
build_large_figure("Heavy", mat_heavy, (-4.0, 0, 0), pose="standing")

# Kneeling nomads to the right — using "seated" pose to approximate kneeling on ground
build_regular_male("Nomad1", mat_nomad1, (1.0, -0.8, 0), pose="seated")
build_regular_male("Nomad2", mat_nomad2, (2.5, 0, 0), pose="seated")
build_regular_male("Nomad3", mat_nomad3, (4.0, 0.8, 0), pose="seated")

# Camera at ground level, wide angle, facing the scene
setup_camera(scene, loc=(-2.0, -8.0, 0.6), target_loc=(0.5, 0, 0.8), lens=24)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_004.png"
