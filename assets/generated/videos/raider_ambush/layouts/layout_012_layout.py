...
# Gale — center, standing, one arm raised (shielding eyes)
build_regular_female("Gale", mat_gale, (0, 0, 0), pose="arms_raised")

# Cranial — getting up from ground, front-left
build_regular_male("Cranial", mat_cranial, (-2.0, -1.0, 0), pose="fallen")

# Gorilla — getting up from ground, front-right
build_large_figure("Gorilla", mat_gorilla, (2.0, -0.5, 0), pose="fallen")

# Robot — getting up from ground, back-left
build_regular_male("Robot", mat_robot, (-1.5, 1.5, 0), pose="fallen")

# Nomad1 — getting up from ground, back-right
build_regular_male("Nomad1", mat_nomad1, (1.5, 1.8, 0), pose="fallen")

# Camera — eye level medium shot, facing center
setup_camera(scene, loc=(0, -5.5, 1.5), target_loc=(0, 0, 1.2), lens=35)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/raider_ambush/layouts/layout_012.png"
