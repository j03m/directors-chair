...
# Seated characters facing +Y (away from camera toward desert)
build_regular_male("Cranial", mat_cranial, (-1.5, 0, 0), pose="seated")
build_large_figure("Gorilla", mat_gorilla, (1.5, 0, 0), pose="seated")

# Robot standing in mid-distance, facing toward the seated figures (facing -Y)
build_regular_male("Robot", mat_robot, (0, 6, 0), pose="standing")

# Camera behind the two seated figures, low angle looking forward into the scene
setup_camera(scene, loc=(0, -4.5, 1.0), target_loc=(0, 3, 1.2), lens=28)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_robot_arrives.png"
