...
# Gorilla — seated in the low chair, slightly left of center
build_large_figure("Gorilla", mat_gorilla, (gx, gy, gz), pose="seated")

# Camera — medium close-up at chest height, framing waist-up
# Gorilla body center is at z+1.1, head at z+2.2 → chest ~1.3
# Close distance + longer lens for medium close-up
setup_camera(scene,
             loc=(gx, gy - 3.2, gz + 1.3),
             target_loc=(gx, gy, gz + 1.4),
             lens=55)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_gorilla_closeup_2.png"
