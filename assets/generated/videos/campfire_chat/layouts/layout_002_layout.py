...
# Cranial seated in the beach chair, slightly right of center
build_regular_male("Cranial", cranial_mat, (1.0, 0, 0.3), pose="seated")

# Camera at chest height for medium close-up, framing waist up
# Character chest is around z=1.2, camera close and at that height
setup_camera(scene, loc=(1.0, -3.0, 1.2), target_loc=(1.0, 0, 1.1), lens=50)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_002.png"
