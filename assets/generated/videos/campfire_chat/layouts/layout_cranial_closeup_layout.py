...
add_mesh("Chair_LegBL", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (1.1, -0.3, 0.12), (0.02, 0.02, 0.12))
add_mesh("Chair_LegBR", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (1.1, 0.3, 0.12), (0.02, 0.02, 0.12))

# Cranial seated in the chair, slightly right of center
build_regular_male("Cranial", mat_cranial, (0.8, 0, 0.25), pose="seated")

# Camera — medium close-up at chest height, framing waist up
# Character chest is around z=1.15 (0.25 chair + 0.9 body center)
# Camera close in front, at chest height
setup_camera(scene, loc=(0.8, -3.0, 1.15), target_loc=(0.8, 0, 1.15), lens=50)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_cranial_closeup.png"
