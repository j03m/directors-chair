...
chair_mat = make_mat("Chair", (0.35, 0.25, 0.15, 1))

# Ground
add_ground(ground_mat)

# Beach chair (simple frame behind/under the gorilla)
# Chair seat - angled back slightly
add_mesh("Chair_Seat", bpy.ops.mesh.primitive_cube_add, chair_mat,
         (-0.8, 0, 0.35), (0.5, 0.4, 0.03),
         rot=(math.radians(-15), 0, 0))
# Chair back - angled recline
add_mesh("Chair_Back", bpy.ops.mesh.primitive_cube_add, chair_mat,
         (-0.8, 0, 0.7), (0.5, 0.03, 0.35),
         rot=(math.radians(-20), 0, 0))
# Chair legs
add_mesh("Chair_LegFL", bpy.ops.mesh.primitive_cylinder_add, chair_mat,
         (-1.2, -0.35, 0.15), (0.03, 0.03, 0.2))
add_mesh("Chair_LegFR", bpy.ops.mesh.primitive_cylinder_add, chair_mat,
         (-1.2, 0.35, 0.15), (0.03, 0.03, 0.2))
add_mesh("Chair_LegBL", bpy.ops.mesh.primitive_cylinder_add, chair_mat,
         (-0.4, -0.35, 0.2), (0.03, 0.03, 0.25))
add_mesh("Chair_LegBR", bpy.ops.mesh.primitive_cylinder_add, chair_mat,
         (-0.4, 0.35, 0.2), (0.03, 0.03, 0.25))

# Gorilla seated in the beach chair, slightly left of center
build_large_figure("Gorilla", gorilla_mat, (-0.8, 0, 0), pose="seated")

# Camera at chest height, medium close-up framing waist-up
# Gorilla chest is around z=1.1, camera close and at that height
setup_camera(scene, loc=(2.5, -1.8, 1.3), target_loc=(-0.8, 0, 1.3), lens=50)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_003.png"
