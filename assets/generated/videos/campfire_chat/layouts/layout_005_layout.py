...
# Seated characters — facing away from camera (toward +Y / open desert)
# Gorilla seated in left chair
build_large_figure("Gorilla", mat_gorilla, (-1.2, 1.0, 0.0), pose="seated")

# Cranial seated in right chair
build_regular_male("Cranial", mat_cranial, (1.2, 1.0, 0.0), pose="seated")

# Robot standing in mid-distance, facing back toward the seated figures
build_regular_male("Robot", mat_robot, (0.0, 5.0, 0.0), pose="standing")

# Camera behind the seated figures, low angle looking forward into the scene
setup_camera(scene, loc=(0.0, -2.5, 0.8), target_loc=(0.0, 3.0, 1.0), lens=28)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_005.png"
