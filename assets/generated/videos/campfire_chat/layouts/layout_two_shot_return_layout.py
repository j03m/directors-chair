...
# Beach chairs — simple flat cubes angled back slightly
...
# Cranial on the left chair
build_regular_male("Cranial", mat_cranial, (-0.9, 0, 0.25), pose="seated")

# Gorilla on the right chair
build_large_figure("Gorilla", mat_gorilla, (1.1, 0, 0.3), pose="seated")

# Camera — low angle, slightly below eye level, about 6 feet (1.8m) away
# Characters face camera (negative Y direction), camera looks at midpoint between them
setup_camera(scene, loc=(0.1, -2.0, 0.8), target_loc=(0.1, 0, 1.0), lens=28)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_two_shot_return.png"
