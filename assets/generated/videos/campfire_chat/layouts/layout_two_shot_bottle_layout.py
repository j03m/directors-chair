...
# Characters — seated side by side, facing camera (negative Y)
# Cranial on the left
build_regular_male("Cranial", mat_cranial, (-0.9, 0.0, 0.0), pose="seated")

# Gorilla on the right
build_large_figure("Gorilla", mat_gorilla, (1.0, 0.0, 0.0), pose="seated")

# Camera — low angle, slightly below eye level, about 6 feet (~1.8m) away
# Characters face negative Y, camera in front looking back at them
setup_camera(scene,
             loc=(0.05, -2.0, 0.55),
             target_loc=(0.05, 0.0, 0.9),
             lens=32)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/campfire_chat/layouts/layout_two_shot_bottle.png"
