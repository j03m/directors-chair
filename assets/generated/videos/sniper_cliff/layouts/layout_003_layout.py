...
mat_chair = make_mat("Chair", (0.15, 0.4, 0.55, 1))

# Ground
add_ground(mat_ground)

# Beach chair for Cranial (left side, seated)
# Chair seat
add_mesh("Chair_Seat", bpy.ops.mesh.primitive_cube_add, mat_chair,
         (-1.5, 0, 0.35), (0.45, 0.35, 0.04),
         rot=(math.radians(-15), 0, 0))
# Chair back
add_mesh("Chair_Back", bpy.ops.mesh.primitive_cube_add, mat_chair,
         (-1.5, 0.3, 0.65), (0.45, 0.04, 0.35),
         rot=(math.radians(-25), 0, 0))
# Chair legs front
add_mesh("Chair_LegFL", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (-1.8, -0.25, 0.15), (0.03, 0.03, 0.2),
         rot=(math.radians(10), 0, 0))
add_mesh("Chair_LegFR", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (-1.2, -0.25, 0.15), (0.03, 0.03, 0.2),
         rot=(math.radians(10), 0, 0))
# Chair legs back
add_mesh("Chair_LegBL", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (-1.8, 0.3, 0.15), (0.03, 0.03, 0.2),
         rot=(math.radians(-10), 0, 0))
add_mesh("Chair_LegBR", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (-1.2, 0.3, 0.15), (0.03, 0.03, 0.2),
         rot=(math.radians(-10), 0, 0))

# Cranial — seated in beach chair on the left
build_regular_male("Cranial", mat_cranial, (-1.5, 0, 0.0), pose="seated")

# Robot — standing to the right
build_regular_male("Robot", mat_robot, (1.5, 0, 0.0), pose="standing")

# Camera — medium two-shot, eye level, facing camera means camera in front
setup_camera(scene, loc=(0, -5, 1.2), target_loc=(0, 0, 1.0), lens=35)

# Render
scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/sniper_cliff/layouts/layout_003.png"
