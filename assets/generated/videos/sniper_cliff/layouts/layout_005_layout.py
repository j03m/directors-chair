...
mat_desert = make_mat("Desert", (0.55, 0.42, 0.25, 1))
mat_cranial = make_mat("Cranial", (0.25, 0.18, 0.1, 1))
mat_gorilla = make_mat("Gorilla", (0.6, 0.6, 0.65, 1))
mat_rifle_cranial = make_mat("RifleCranial", (0.15, 0.12, 0.08, 1))
mat_rifle_gorilla = make_mat("RifleGorilla", (0.12, 0.1, 0.08, 1))

# Ground plane (desert floor far below)
add_ground(mat_ground, size=15)

# Cliff top platform — elevated flat surface where the figures lie
add_mesh("CliffTop", bpy.ops.mesh.primitive_cube_add, mat_cliff,
         (0, 0, 1.5), (4, 5, 1.5))

# Cliff face — the vertical drop-off in front
add_mesh("CliffFace", bpy.ops.mesh.primitive_cube_add, mat_cliff,
         (0, -5.5, 0.5), (4, 0.5, 0.5))

# Desert landscape below (visible past the cliff edge)
add_mesh("DesertFloor", bpy.ops.mesh.primitive_plane_add, mat_desert,
         (0, -10, 0), (10, 8, 1))

# Distant rock formations for depth
add_mesh("Rock1", bpy.ops.mesh.primitive_cube_add, mat_cliff,
         (-5, -14, 0.8), (1.2, 0.8, 0.8),
         rot=(0, 0, math.radians(15)))
add_mesh("Rock2", bpy.ops.mesh.primitive_cube_add, mat_cliff,
         (4, -16, 0.6), (0.8, 0.6, 0.6),
         rot=(0, 0, math.radians(-10)))
add_mesh("Rock3", bpy.ops.mesh.primitive_cone_add, mat_cliff,
         (0, -18, 1.0), (1.5, 1.5, 1.0))

# --- PRONE FIGURES ---
# Both figures lie prone (fallen pose adapted for prone/belly-down) at cliff edge
# Gorilla (large) on the right, Cranial (regular male) on the left
# They face forward (negative Y) looking over the cliff edge

# Cranial — prone on the left, facing the cliff edge
# Body flat, head extended forward over edge
add_mesh("Cranial_Body", bpy.ops.mesh.primitive_cube_add, mat_cranial,
         (-1.2, -3.0, 3.15), (0.4, 0.55, 0.18),
         rot=(math.radians(5), 0, 0))
add_mesh("Cranial_Head", bpy.ops.mesh.primitive_cube_add, mat_cranial,
         (-1.2, -3.8, 3.15), (0.2, 0.18, 0.15),
...
add_mesh("Cranial_ArmL", bpy.ops.mesh.primitive_cylinder_add, mat_cranial,
         (-1.5, -3.5, 3.12), (0.08, 0.08, 0.35),
         rot=(math.radians(85), 0, math.radians(-10)))
add_mesh("Cranial_ArmR", bpy.ops.mesh.primitive_cylinder_add, mat_cranial,
         (-0.9, -3.5, 3.12), (0.08, 0.08, 0.35),
         rot=(math.radians(85), 0, math.radians(10)))
# Legs stretched behind
add_mesh("Cranial_LegL", bpy.ops.mesh.primitive_cylinder_add, mat_cranial,
         (-1.4, -2.0, 3.1), (0.09, 0.09, 0.45),
         rot=(math.radians(90), 0, math.radians(-5)))
add_mesh("Cranial_LegR", bpy.ops.mesh.primitive_cylinder_add, mat_cranial,
         (-1.0, -2.0, 3.1), (0.09, 0.09, 0.45),
         rot=(math.radians(90), 0, math.radians(5)))
# Rifle
add_mesh("Cranial_Rifle", bpy.ops.mesh.primitive_cylinder_add, mat_rifle_cranial,
         (-1.2, -4.2, 3.18), (0.03, 0.03, 0.6),
         rot=(math.radians(88), 0, 0))

# Gorilla — prone on the right, facing the cliff edge
# Larger body, same prone orientation
add_mesh("Gorilla_Body", bpy.ops.mesh.primitive_cube_add, mat_gorilla,
         (1.2, -3.0, 3.25), (0.6, 0.7, 0.28),
         rot=(math.radians(5), 0, 0))
add_mesh("Gorilla_Head", bpy.ops.mesh.primitive_uv_sphere_add, mat_gorilla,
         (1.2, -3.9, 3.28), (0.32, 0.28, 0.25),
         rot=(math.radians(15), 0, 0))
# Arms extended forward holding rifle
add_mesh("Gorilla_ArmL", bpy.ops.mesh.primitive_cylinder_add, mat_gorilla,
         (0.5, -3.6, 3.2), (0.12, 0.12, 0.45),
         rot=(math.radians(85), 0, math.radians(-10)))
add_mesh("Gorilla_ArmR", bpy.ops.mesh.primitive_cylinder_add, mat_gorilla,
         (1.9, -3.6, 3.2), (0.12, 0.12, 0.45),
         rot=(math.radians(85), 0, math.radians(10)))
# Legs stretched behind
add_mesh("Gorilla_LegL", bpy.ops.mesh.primitive_cylinder_add, mat_gorilla,
         (0.8, -1.8, 3.15), (0.14, 0.14, 0.5),
         rot=(math.radians(90), 0, math.radians(-5)))
add_mesh("Gorilla_LegR", bpy.ops.mesh.primitive_cylinder_add, mat_gorilla,
         (1.6, -1.8, 3.15), (0.14, 0.14, 0.5),
         rot=(math.radians(90), 0, math.radians(5)))
# Rifle (larger)
add_mesh("Gorilla_Rifle", bpy.ops.mesh.primitive_cylinder_add, mat_rifle_gorilla,
         (1.2, -4.4, 3.32), (0.04, 0.04, 0.7),
         rot=(math.radians(88), 0, 0))

# Camera — low angle, slightly behind and to the side, ground level
# Looking at the two prone figures at the cliff edge
setup_camera(scene, loc=(4.5, 1.5, 3.5), target_loc=(0, -3.5, 3.2), lens=24)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/sniper_cliff/layouts/layout_005.png"
