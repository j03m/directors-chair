...
add_mesh("Chair_LegBL", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (-0.4, 0.45, 0.15), (0.03, 0.03, 0.18))
add_mesh("Chair_LegBR", bpy.ops.mesh.primitive_cylinder_add, mat_chair,
         (0.4, 0.45, 0.15), (0.03, 0.03, 0.18))

# Cranial - seated in the beach chair, facing camera (negative Y)
build_regular_male("Cranial", mat_cranial, (0, 0, 0.15), pose="seated")

# Camera - medium close-up, positioned in front and slightly above for upper body framing
setup_camera(scene, loc=(0, -2.8, 1.5), target_loc=(0, 0, 1.2), lens=50)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/sniper_cliff/layouts/layout_001.png"
