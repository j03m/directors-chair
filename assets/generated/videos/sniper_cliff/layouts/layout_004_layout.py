...
add_mesh("Chair_LegBL", bpy.ops.mesh.primitive_cylinder_add, chair_mat,
         (-0.35, 0.55, 0.25), (0.02, 0.02, 0.25))
add_mesh("Chair_LegBR", bpy.ops.mesh.primitive_cylinder_add, chair_mat,
         (0.35, 0.55, 0.25), (0.02, 0.02, 0.25))

# Cranial standing up from the chair (mid-rise, use standing pose slightly forward)
build_regular_male("Cranial", cranial_mat, (0, 0, 0), pose="standing")

# Camera: medium shot, eye level, about 6 feet (~1.8m) away, facing the character
setup_camera(scene, loc=(0, -2.5, 1.2), target_loc=(0, 0, 1.0), lens=35)

scene.frame_set(1)
scene.render.filepath = "/Users/jmordetsky/directors-chair/assets/generated/videos/sniper_cliff/layouts/layout_004.png"
