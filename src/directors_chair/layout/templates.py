# Blender helper functions template
# This string gets prepended to every LLM-generated Blender script.
...
# Material colors for distinguishing characters
CHARACTER_COLORS = [
    (0.25, 0.18, 0.1, 1),   # Warm brown
    (0.6, 0.6, 0.65, 1),    # Light gray
    (0.2, 0.35, 0.5, 1),    # Steel blue
    (0.5, 0.2, 0.2, 1),     # Rust red
    (0.3, 0.4, 0.2, 1),     # Olive green
]

BODY_TYPE_BUILDERS = {
    "large": "build_large_figure",
    "regular_male": "build_regular_male",
    "regular_female": "build_regular_female",
}
